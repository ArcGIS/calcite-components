import { h as E, L as g, k as v, x as a, s as c, E as l, j as x } from "./iframe.js";
...
class O extends g {
  constructor() {
    super(...arguments), this.guid = `calcite-action-menu-${M()}`, this.actionElements = [], this.menuButtonClick = () => {
      ...
      e.tabIndex = -1, e.setAttribute("role", "menuitem"), e.id || (e.id = i), e.toggleAttribute(C, t === o);
  ...
  renderMenuButton() {
    ...
    return a`<slot name=${d.trigger} @slotchange=${this.setMenuButtonEl}><calcite-action .appearance=${e} class=${c(h.defaultTrigger)} .icon=${y.menu} .scale=${n} .text=${t} .textEnabled=${o} ${r(this.setDefaultMenuButtonEl)}></calcite-action></slot>`;
  }
  renderMenuItems() {
