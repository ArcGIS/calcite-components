import { h as p, L as m, k as u, x as r, s as i, j as h } from "./iframe.js";
import { s as v, a as g } from "./loadable.js";
...
class k extends m {
  constructor() {
    super(...arguments), this.active = !1, this.disabled = !1, this.guid = `autocomplete-item-${z()}`, this.scale = "m", this.calciteInternalAutocompleteItemSelect = u({ cancelable: !1 });
  }
  static {
  ...
  render() {
    ...
    return x({ disabled: n, children: r`<div class=${i({
      [t.container]: !0,
  ...
  renderIcon(e) {
    ...
    return a ? r`<calcite-icon class=${i(e === "start" ? t.iconStart : t.iconEnd)} .flipRtl=${c === e || c === "both"} .icon=${a} .scale=${f(this.scale)}></calcite-icon>` : null;
  }
}
h("calcite-autocomplete-item", k);
export {
