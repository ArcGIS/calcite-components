import { h as $, L as y, u as C, k as c, n as f, x as h, s as r, E as s, j as k } from "./iframe.js";
import { n as d } from "./ref.js";
import { c as A } from "./repeat.js";
import { d as g, r as E, c as u, b as T, F as b } from "./floating-ui.js";
import { u as O, I as S } from "./interactive.js";
import { s as w, a as z } from "./loadable.js";
import { o as m } from "./openCloseComponent.js";
import { c as F, d as D } from "./label.js";
import { c as H, a as L, d as V, s as P, H as B } from "./form.js";
...
import { S as I, I as G, C as l } from "./resources5.js";
...
class N extends y {
  ...
  constructor() {
    super(), this.guid = M(), this.attributeWatch = C(["autofocus", "enterkeyhint", "inputmode"], this.handleGlobalAttributesChanged), this.inputId = `autocomplete-input-${this.guid}`, this.listId = `autocomplete-list-${this.guid}`, this.messages = U(), this.openTransitionProp = "opacity", this.activeDescendant = "", this.activeIndex = -1, this.hasContentBottom = !1, this.hasContentTop = !1, this.items = [], this.groups = [], this.alignment = "start", this.disabled = !1, this.iconFlipRtl = !1, this.loading = !1, this.open = !1, this.overlayPositioning = "absolute", this.placement = g, this.readOnly = !1, this.required = !1, this.scale = "m", this.status = "idle", this.validity = {
      ...
      typeMismatch: !1,
      valueMissing: !1
    }, this.value = "", this.calciteAutocompleteBeforeClose = c({ cancelable: !1 }), this.calciteAutocompleteBeforeOpen = c({ cancelable: !1 }), this.calciteAutocompleteChange = c({ cancelable: !1 }), this.calciteAutocompleteClose = c({ cancelable: !1 }), this.calciteAutocompleteOpen = c({ cancelable: !1 }), this.calciteAutocompleteTextChange = c({ cancelable: !1 }), this.calciteAutocompleteTextInput = c({ cancelable: !1 }), this.mutationObserver = x("mutation", () => this.getAllItemsDebounced()), this.resizeObserver = x("resize", () => {
      this.setFloatingElSize();
    }), this.getAllItemsDebounced = q(this.getAllItems, 0), this.listenOn(document, "click", this.documentClickHandler), this.listen("calciteInternalAutocompleteItemSelect", this.handleInternalAutocompleteItemSelect);
  }
  static {
    this.properties = { activeDescendant: 16, activeIndex: 16, hasContentBottom: 16, hasContentTop: 16, items: 16, groups: 16, isOpen: 16, enabledItems: 16, alignment: 3, autocomplete: 0, disabled: 7, flipPlacements: 0, form: 3, icon: [3, { converter: f }], iconFlipRtl: 7, inputValue: 1, label: 1, loading: 7, maxLength: 11, messageOverrides: 0, minLength: 11, name: 3, open: 7, overlayPositioning: 3, pattern: 1, placeholder: 1, placement: 3, prefixText: 1, readOnly: 7, required: 7, scale: 3, status: 3, suffixText: 1, validationIcon: [3, { converter: f }], validationMessage: 1, validity: 0, value: 1 };
  }
  static {
    this.styles = K;
  }
  ...
  connectedCallback() {
    super.connectedCallback(), this.mutationObserver?.observe(this.el, { childList: !0, subtree: !0 }), F(this), H(this), this.defaultInputValue = this.inputValue || "", this.getAllItemsDebounced(), this.open && (this.openHandler(), m(this)), u(this);
  }
  async load() {
    w(this), this.getAllItemsDebounced(), this.open && m(this);
  }
  willUpdate(t) {
    t.has("disabled") && (this.hasUpdated || this.disabled !== !1) && this.handleDisabledChange(this.disabled), t.has("flipPlacements") && this.reposition(!0), t.has("open") && (this.hasUpdated || this.open !== !1) && this.openHandler(), t.has("overlayPositioning") && (this.hasUpdated || this.overlayPositioning !== "absolute") && this.reposition(!0), t.has("placement") && (this.hasUpdated || this.placement !== g) && this.reposition(!0);
    let e = !1;
    t.has("inputValue") && (this.hasUpdated || this.inputValue) && (this.inputValueMatchPattern = this.inputValue && new RegExp(`(${W(this.inputValue)})`, "i"), this.updateItems(), this.updateGroups(), e = !0), !e && t.has("scale") && (this.hasUpdated || this.scale !== "m") && (this.updateItems(), this.updateGroups(), e = !0), !e && t.has("activeIndex") && (this.hasUpdated || this.activeIndex !== -1) && this.updateItems();
  }
  updated() {
    O(this);
  }
  loaded() {
    L(this, this.value || ""), this.defaultInputValue = this.inputValue || "", z(this), u(this);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.mutationObserver?.disconnect(), this.resizeObserver?.disconnect(), D(this), V(this), T(this);
  }
  // #endregion
  ...
  openHandler() {
    if (m(this), this.open || (this.activeIndex = -1), this.disabled) {
      this.open = !1;
      return;
    }
  ...
  getAllItems() {
    const { el: t } = this;
    this.groups = Array.from(t.querySelectorAll(j)), this.items = Array.from(t.querySelectorAll(J)), this.updateItems(), this.updateGroups();
  }
  setReferenceEl(t) {
    this.referenceEl = t, t && (this.resizeObserver?.observe(t), u(this));
  }
  keyDownHandler(t) {
    const { defaultPrevented: e, key: n } = t;
    if (e)
      return;
    const { open: i, activeIndex: o, enabledItems: a } = this, p = a.length && o > -1 ? a[o] : null;
    switch (n) {
      case "Escape":
      ...
      case "Tab":
        ...
        break;
      case "Enter":
        i && p ? (this.value = p.value, this.emitChange(), this.open = !1, t.preventDefault()) : t.defaultPrevented || P(this) && t.preventDefault();
        break;
      case "ArrowDown":
  ...
  render() {
    ...
    return S({ disabled: t, children: h`<div class=${r(l.inputContainer)}><calcite-input .alignment=${this.alignment} aria-activedescendant=${this.activeDescendant ?? s} aria-controls=${e ?? s} aria-owns=${e ?? s} aria-autocomplete=list .ariaExpanded=${i} aria-haspopup=listbox .autocomplete=${this.autocomplete} .autofocus=${o} class=${r(l.input)} clearable .disabled=${t} enterkeyhint=${a ?? s} .form=${this.form} .icon=${this.icon ?? !0} .iconFlipRtl=${this.iconFlipRtl} id=${n ?? s} inputmode=${p ?? s} .label=${this.label} .loading=${this.loading} .maxLength=${this.maxLength} .messageOverrides=${this.messages} .minLength=${this.minLength} .name=${this.name} @click=${this.inputClickHandler} @keydown=${this.keyDownHandler} @calciteInputChange=${this.changeHandler} @calciteInputInput=${this.inputHandler} @calciteInternalInputFocus=${this.handleInputFocus} .pattern=${this.pattern} .placeholder=${this.placeholder} .prefixText=${this.prefixText} .readOnly=${this.readOnly} role=combobox .scale=${this.scale} .status=${this.status} .suffixText=${this.suffixText} type=search .value=${this.inputValue} ${d(this.setReferenceEl)}></calcite-input>${this.renderListBox()}<div class=${r({
      ...
      [b.animation]: !0,
      [b.animationActive]: i
    })} ${d(this.setTransitionEl)}><div class=${r({ [l.content]: !0, [l.contentHidden]: !i })}><slot name=${I.contentTop} @slotchange=${this.handleContentTopSlotChange}></slot><slot aria-hidden=true></slot><slot name=${I.contentBottom} @slotchange=${this.handleContentBottomSlotChange}></slot></div></div></div></div>${B({ component: this })}${this.validationMessage && this.status === "invalid" ? R({ icon: this.validationIcon, id: G.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status }) : null}` });
  }
  renderListBox() {
  ...
  renderListBoxOptions() {
    return A(this.items.filter((t) => !!(t.label || t.heading)), (t) => t.guid, (t) => h`<li .ariaDisabled=${t.disabled} .ariaLabel=${t.label} id=${t.guid ?? s} role=option tabindex=-1>${t.heading}${t.description}</li>`);
  }
}
k("calcite-autocomplete", N);
export {
  N as Autocomplete
};
