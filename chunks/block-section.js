import { h, L as v, k as p, x as l, s as c, y as u, j as b } from "./iframe.js";
import { i as x } from "./keyed.js";
import { f } from "./dom.js";
import { i as m } from "./key.js";
import { c as k, s as $, a as w } from "./loadable.js";
...
class I extends v {
  ...
  renderIcon(e) {
    ...
    return x(n ? this.iconStart : this.iconEnd, l`<calcite-icon class=${c(n ? t.iconStart : t.iconEnd)} .flipRtl=${n ? i : r} .icon=${n ? this.iconStart : this.iconEnd} scale=s></calcite-icon>`);
  }
  render() {
    const { messages: e, open: o, text: i, toggleDisplay: r } = this, n = o ? s.menuOpen : s.menuClosed, d = o ? e.collapse : e.expand, g = r === "switch" ? l`<div class=${c({
      [t.toggleContainer]: !0
