import { h as d, L as h, k as s, x as i, s as a, j as p } from "./iframe.js";
import { e as b, n as u } from "./ref.js";
import { s as o } from "./dom.js";
import { c as g, s as m, a as f } from "./loadable.js";
import { u as v, I as x } from "./interactive.js";
...
class C extends h {
  constructor() {
    super(...arguments), this.containerEl = b(), this.hasContent = !1, this.hasDescription = !1, this.hasFooterEnd = !1, this.hasFooterStart = !1, this.hasHeading = !1, this.hasSubtitle = !1, this.hasThumbnail = !1, this.hasTitle = !1, this.disabled = !1, this.loading = !1, this.messages = w(), this.selectable = !1, this.selected = !1, this.selectionMode = "none", this.thumbnailPosition = "block-start", this.calciteCardSelect = s({ cancelable: !1 }), this.calciteInternalCardKeyEvent = s({ cancelable: !1 });
  }
  static {
  ...
  keyDownHandler(e) {
    if (e.target === this.containerEl.value && !this.selectable && !this.disabled)
      if (k(e.key) && this.selectionMode !== "none")
