import { h as a, L as c, k as t, x as l, s as o, y as s, d as n, j as r, C as h } from "./iframe.js";
...
import { c as z, s as w, a as L } from "./loadable.js";
/*!
...
class F extends c {
  ...
  render() {
    ...
    return f({ disabled: this.disabled, children: l`<div .ariaChecked=${this.checked} .ariaLabel=${C(this)} class=${o({
      [i.toggle]: !0,
      [h.rtl]: e
    })} @blur=${this.onToggleBlur} @focus=${this.onToggleFocus} role=checkbox tabindex=${(this.disabled ? void 0 : 0) ?? s} ${g(this.toggleEl)}><svg aria-hidden=true class=${o(i.check)} viewBox="0 0 16 16">${n`<path d=${this.getPath() ?? s} />`}</svg><slot></slot></div>${k({ component: this })}` });
  }
}
r("calcite-checkbox", F);
export {
  F as Checkbox
};
