...
class C extends c {
  ...
  render() {
    ...
    return f({ disabled: t, children: n`<div .ariaLabel=${this.label} class="container" .role=${e}><slot @slotchange=${this.updateItems} ${r(this.slotRefEl)}></slot></div>` });
  }
}
h("calcite-chip-group", C);
export {
  C as ChipGroup
};
