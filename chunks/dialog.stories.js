import { b as o, m as M } from "./utils.js";
import { h as e } from "./formatting.js";
import { A as q } from "./resources14.js";
import { d as H, S as t } from "./resources7.js";
/*!
...
const {
  ...
  args: {
    ...
    dragEnabled: !1,
    resizable: !1,
    overlayPositioning: z.defaultValue,
    outsideCloseDisabled: !1
  },
  argTypes: {
    kind: {
      options: F.values.filter((a) => a !== "inverse" && a !== "neutral"),
      control: {
        type: "select"
      }
    },
  ...
  parameters: {
    ...
    icon="bluetooth"
  ></calcite-action>
  <calcite-action text="Action" label="Action" slot="${t.headerActionsEnd}" icon="attachment"></calcite-action>`, P = e` <calcite-action
    text="banana"
    text-enabled
    icon="banana"
  ...
  >
    ${I} ${P} The small modal is perfect for short confirmation dialogs or very compact
...
`, n = e`<calcite-button
  ...
  <calcite-button slot="${t.footerEnd}" width="auto">Save</calcite-button>`, d = () => e`
...
`, U = e`--calcite-dialog-scrim-background-color: purple; --calcite-dialog-size-x: 400px;
--calcite-dialog-size-y: 400px; --calcite-dialog-footer-space: 50px; --calcite-dialog-border-color: pink;
--calcite-dialog-content-space: 50px; --calcite-dialog-offset-x: 50px; --calcite-dialog-offset-y: -30px;`, O = () => e`<calcite-dialog open modal heading="heading" description="description" scale="m" width-scale="l">
    <calcite-shell>
  ...
  </calcite-dialog>`, B = () => e`<calcite-dialog
    style="${U}"
    open
    modal
    heading="heading"
...
export {
  ...
  h as loading,
  b as menuOpen,
  A as placementBottom,
  L as placementBottomEnd,
  k as placementBottomStart,
  C as placementTop,
  T as placementTopEnd,
  y as placementTopStart,
  w as scaleL,
  f as scaleS,
  s as simple,
  d as slots,
  ...
  v as widthScaleM,
  x as withAlertsSlot,
  m as withCustomContent,
  u as withCustomContentDivPanel,
  g as withCustomContentPanel,
  p as withCustomHeader,
  S as withFooter,
  O as withShellInside,
  c as withTooltips
};
