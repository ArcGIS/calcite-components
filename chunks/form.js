...
function R(e, { status: t, message: a, icon: n }) {
...
const A = new CustomEvent("calciteInvalid", { bubbles: !0, composed: !0 });
function I(e) {
  ...
  if (o.length < 2 || o[0] !== "calcite")
    return;
  e?.preventDefault(), "validity" in n && (n.validity = t?.validity), n.dispatchEvent(A), R(n, {
    message: a,
    icon: !0,
    status: "invalid"
  });
...
function P(e) {
  ...
  const f = Array.isArray(i) ? i : [i], d = [], c = /* @__PURE__ */ new Set();
  l.forEach((s) => {
    const r = f.find((y) => (
      /* intentional non-strict equality check */
      y == s.value
    ));
    r != null ? (c.add(r), p(e, s, r)) : d.push(s);
  });
  let u;
  f.forEach((s) => {
    if (c.has(s))
