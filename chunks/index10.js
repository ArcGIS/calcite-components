...
function Ft() {
  ...
  function G(t, u, f, h, v) {
    ...
    if (S) return S = t, v = v(S), t = h === "" ? "." + ue(S, 0) : h, oe(v) ? (f = "", t != null && (f = t.replace(pe, "$&/") + "/"), G(v, u, f, "", function(P) {
      return P;
    })) : v != null && (K(v) && (v = q(v, f + (!v.key || S && S.key === v.key ? "" : ("" + v.key).replace(pe, "$&/") + "/") + t)), u.push(v)), 1;
  ...
  var w = { current: null }, p = { transition: null }, ve = { ReactCurrentDispatcher: w, ReactCurrentBatchConfig: p, ReactCurrentOwner: T };
  function ie() {
    throw Error("act(...) is not supported in production builds of React.");
  }
  return d.Children = { map: Q, forEach: function(t, u, f) {
    Q(t, function() {
    ...
    return t;
  } }, d.Component = x, d.Fragment = Oe, d.Profiler = U, d.PureComponent = ae, d.StrictMode = Te, d.Suspense = re, d.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ve, d.act = ie, d.cloneElement = function(t, u, f) {
    ...
    return t = { $$typeof: W, _currentValue: t, _currentValue2: t, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, t.Provider = { $$typeof: de, _context: t }, t.Consumer = t;
  }, d.createElement = L, d.createFactory = function(t) {
    var u = L.bind(null, t);
    return u.type = t, u;
  ...
  }, d.isValidElement = K, d.lazy = function(t) {
  ...
  }, d.unstable_act = ie, d.useCallback = function(t, u) {
...
function xt() {
  return Tr || (Tr = 1, function(I, l) {
    ...
    Oe.NODE_ENV !== "production" && function() {
      ...
      function t(e, r) {
        {
          ...
          if (ie[o])
            return;
          p("Can't call %s on a component that is not yet mounted. This is a no-op, but it might indicate a bug in your application. Instead, assign to `this.state` directly or define a `state = {};` class property with the desired state in the %s component.", r, a), ie[o] = !0;
        }
      }
      var u = {
        /**
      ...
      function he(e) {
        if (Ar(e))
          return p("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", jr(e)), Ye(e);
      }
      function Ir(e, r, n) {
        var a = e.displayName;
        if (a)
      ...
      function Dr(e, r) {
        var n = function() {
          qe || (qe = !0, p("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
      ...
      function Hr(e) {
        ...
        var n = !1, a = !1, o = !1;
        {
          ...
          Object.defineProperties(s, {
            ...
            Consumer: {
              get: function() {
                return n || (n = !0, p("Rendering <Context.Consumer.Consumer> is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?")), r.Consumer;
              }
            },
            displayName: {
              get: function() {
      ...
      function Kr(e) {
        ...
        if (e._status === Ze) {
          var o = e._result;
          return o === void 0 && p(`lazy: Expected the result of a dynamic import() call. Instead received: %s

Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))

Did you accidentally put curly braces around the import?`, o), "default" in o || p(`lazy: Expected the result of a dynamic import() call. Instead received: %s
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, o), o.default;
        ...
        };
        {
          ...
          Object.defineProperties(n, {
            defaultProps: {
              ...
              set: function(s) {
                p("React.lazy(...): It is not supported to assign `defaultProps` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it."), a = s, Object.defineProperty(n, "defaultProps", {
                  enumerable: !0
                });
              }
            },
            propTypes: {
              ...
              set: function(s) {
                p("React.lazy(...): It is not supported to assign `propTypes` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it."), o = s, Object.defineProperty(n, "propTypes", {
                  enumerable: !0
                });
              }
            }
      ...
      function rr(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === W || e === re || Q || e === ee || e === z || e === B || G || e === x || ke || pe || ue || typeof e == "object" && e !== null && (e.$$typeof === V || e.$$typeof === $ || e.$$typeof === te || e.$$typeof === Y || e.$$typeof === F || // This needs to include all possible module reference object
      ...
      function Xr(e, r) {
        rr(e) || p("memo: The first argument must be a component. Instead received: %s", e === null ? "null" : typeof e);
        var n = {
          $$typeof: $,
          type: e,
...
` + c[m].replace(" at new ", " at ");
      ...
      var lr = {}, dr = M.ReactDebugCurrentFrame;
      function Re(e) {
        if (e) {
      ...
      function _t(e, r, n, a, o) {
        {
          ...
          for (var i in e)
            if (s(e, i)) {
              ...
              c && !(c instanceof Error) && (Re(o), p("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", a || "React class", n, i, typeof c), Re(null)), c instanceof Error && !(c.message in lr) && (lr[c.message] = !0, Re(o), p("Failed %s type: %s", n, c.message), Re(null));
            }
        }
      }
      function J(e) {
...
Check the top-level render call using <` + n + ">.");
      ...
      function yr(e, r) {
        if (!(!e._store || e._store.validated || e.key != null)) {
          ...
          if (!vr[n]) {
            vr[n] = !0;
            var a = "";
            e && e._owner && e._owner !== A.current && (a = " It was passed a child from " + N(e._owner.type) + "."), J(e), p('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', n, a), J(null);
          }
        }
      }
      function hr(e, r) {
      ...
      function _r(e, r, n) {
        ...
        if (!a) {
          ...
          s ? o += s : o += pr();
          var i;
          e === null ? i = "null" : ye(e) ? i = "array" : e !== void 0 && e.$$typeof === U ? (i = "<" + (N(e.type) || "Unknown") + " />", o = " Did you accidentally export a JSX literal instead of a component?") : i = typeof e, p("React.createElement: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", i, o);
        }
      ...
      function Ot(e) {
        if (Ce === null)
          try {
            ...
            Ce = function(o) {
              br === !1 && (br = !0, typeof MessageChannel > "u" && p("This browser does not have a MessageChannel implementation, so enqueuing tasks via await act(async () => ...) will fail. Please file an issue at https://github.com/facebook/react/issues if you encounter this warning."));
      ...
      function Rr(e) {
        {
          ...
          if (a !== null && typeof a == "object" && typeof a.then == "function") {
            ...
            return !Er && typeof Promise < "u" && Promise.resolve().then(function() {
              ...
              i || (Er = !0, p("You called act(async () => ...) without await. This could lead to unexpected testing behaviour, interleaving multiple act calls and mixing their scopes. You should - await act(async () => ...);"));
            }), c;
          } else {
            var y = a;
            if (we(r), Z === 0) {
      ...
      function we(e) {
        e !== Z - 1 && p("You seem to have overlapping act() calls, this is not supported. Be sure to await previous act() calls before making a new one. "), Z = e;
      }
      function Me(e, r, n) {
        {
          var a = T.current;
