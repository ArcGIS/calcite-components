import { h as E, L as S, u as H, k as g, n as k, x as d, s as a, E as h, j as B, C } from "./iframe.js";
import { l as F } from "./live.js";
import { i as O } from "./keyed.js";
import { e as I, n as y } from "./ref.js";
import { u as w, e as z, g as D } from "./dom.js";
...
import { c as q, s as R, a as G } from "./loadable.js";
import { i as p, n as s, B as Y, p as Z, s as J, h as Q } from "./locale.js";
import { g as v } from "./component.js";
import { V as X } from "./Validation.js";
import { s as tt } from "./input.js";
import { u as et } from "./useT9n.js";
/*!
...
class rt extends S {
  ...
  constructor() {
    ...
    }, this.previousValueOrigin = "initial", this.userChangedValue = !1, this._value = "", this.slottedActionElDisabledInternally = !1, this.alignment = "start", this.clearable = !1, this.disabled = !1, this.editingEnabled = !1, this.groupSeparator = !1, this.iconFlipRtl = !1, this.integer = !1, this.loading = !1, this.localeFormat = !1, this.messages = et(), this.numberButtonType = "vertical", this.readOnly = !1, this.required = !1, this.scale = "m", this.status = "idle", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
  ...
  incrementOrDecrementNumberValue(t, e, i, m) {
    ...
    if (n === "Infinity" || n === "-Infinity")
      return;
    const l = t === "up" ? 1 : -1, u = this.integer && this.step !== "any" ? Math.round(this.step) : this.step, b = u === "any" ? 1 : Math.abs(u || 1), o = new Y(n !== "" ? n : "0").add(`${b * l}`), c = () => typeof i == "number" && !isNaN(i) && o.subtract(`${i}`).isNegative, x = () => typeof e == "number" && !isNaN(e) && !o.subtract(`${e}`).isNegative, $ = c() ? `${i}` : x() ? `${e}` : o.toString();
    this.setNumberValue({
      committing: !0,
      nativeEvent: m,
      origin: "user",
  ...
  setNumberValue({ committing: t = !1, nativeEvent: e, origin: i, previousValue: m, value: n }) {
    ...
    const l = this.previousValue?.length > n.length || this.value?.length > n.length, u = this.integer ? n.replace(/[e.]/g, "") : n, b = u.charAt(u.length - 1) === ".", f = b && l ? u : J(u), o = n && !f ? p(this.previousValue) ? this.previousValue : "" : f;
    let c = s.localize(o);
    i !== "connected" && !b && (c = Q(c, o, s)), this.displayedValue = b && l ? `${c}${s.decimal}` : c, this.setPreviousNumberValue(m ?? this.value), this.previousValueOrigin = i, this.userChangedValue = i === "user" && this.value !== o, this.value = ["-", "."].includes(o) ? "" : o, i === "direct" && (this.setInputNumberValue(c), this.setPreviousEmittedNumberValue(c)), e && (this.calciteInputNumberInput.emit().defaultPrevented ? (this.value = this.previousValue, this.displayedValue = s.localize(this.previousValue)) : t && this.emitChangeIfUserModified());
  }
