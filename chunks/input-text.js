import { h as x, L as k, u as y, k as r, n as p, x as s, s as a, E as i, j as I, C as w } from "./iframe.js";
import { l as E } from "./live.js";
import { e as h, n as d } from "./ref.js";
import { u as f, g as $ } from "./dom.js";
import { c as z, i as m, d as T, s as C, H as V } from "./form.js";
import { u as H, I as F } from "./interactive.js";
import { c as L, d as M, g as O } from "./label.js";
import { c as W, s as P, a as q } from "./loadable.js";
...
class A extends k {
  ...
  constructor() {
    ...
    }, this.previousValueOrigin = "initial", this.userChangedValue = !1, this._value = "", this.slottedActionElDisabledInternally = !1, this.alignment = "start", this.clearable = !1, this.disabled = !1, this.editingEnabled = !1, this.iconFlipRtl = !1, this.loading = !1, this.messages = U(), this.readOnly = !1, this.required = !1, this.scale = "m", this.status = "idle", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
  ...
  connectedCallback() {
    super.connectedCallback(), this.inlineEditableEl = this.el.closest("calcite-inline-editable"), this.inlineEditableEl && (this.editingEnabled = this.inlineEditableEl.editingEnabled || !1), L(this), z(this), this.el.addEventListener(m, this.onHiddenFormInputInput);
  }
  async load() {
    P(this), this.requestedIcon = f({}, this.icon, "text"), this.setPreviousEmittedValue(this.value), this.setPreviousValue(this.value);
  }
  willUpdate(e) {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), M(this), T(this), this.el.removeEventListener(m, this.onHiddenFormInputInput);
  }
  // #endregion
