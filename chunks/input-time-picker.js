import { h as be, L as Ye, k as A, n as Fe, x as ne, E as N, s as Oe, j as Pe } from "./iframe.js";
...
import { c as We, s as Be, a as je } from "./loadable.js";
import { n as q, l as G, g as se } from "./locale.js";
import { i as K, t as oe, d as Q, j as Ze, k as Re, n as le, f as X, o as Je, e as qe, q as Ge } from "./time.js";
import { d as W } from "./math.js";
import { g as Ke } from "./component.js";
import { V as Qe } from "./Validation.js";
import { f as Xe } from "./dom.js";
import { s as et } from "./input.js";
import { u as tt } from "./useT9n.js";
/*!
 * All material copyright ESRI, All Rights Reserved, unless otherwise specified.
 * See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
 * v3.0.0-next.100
*/
var pe = 60, ve = pe * 60, ge = ve * 24, it = ge * 7, E = 1e3, ee = pe * E, ce = ve * E, rt = ge * E, at = it * E, re = "millisecond", O = "second", P = "minute", C = "hour", w = "day", B = "week", I = "month", Se = "quarter", b = "year", H = "date", $e = "YYYY-MM-DDTHH:mm:ssZ", ue = "Invalid Date", nt = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, st = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g;
const Me = {
  name: "en",
...
var pt = function(e) {
  ...
  return e.parse = function(i) {
    ...
    return n.replace(st, function(S, v) {
...
}, vt = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, he = /\d/, x = /\d\d/, gt = /\d{3}/, St = /\d{4}/, T = /\d\d?/, $t = /[+-]?\d+/, Mt = /[+-]\d\d:?(\d\d)?|Z/, z = /\d*[^-_:/,()\s\d]+/, Y = {}, ke = function(e) {
...
var y = function(e) {
  ...
  DD: [x, y("day")],
  Do: [z, function(s) {
    var e = Y, t = e.ordinal, i = s.match(/\d+/);
    if (this.day = i[0], !!t)
...
function Tt(s) {
  s = Ie(s, Y && Y.formats);
  for (var e = s.match(vt), t = e.length, i = 0; i < t; i += 1) {
    var r = e[i], a = Dt[r], n = a && a[0], l = a && a[1];
    l ? e[i] = {
      regex: n,
      parser: l
    } : e[i] = r.replace(/^\[|\]$/g, "");
...
var It = function(e, t, i, r) {
  try {
    ...
    var a = Tt(t), n = a(e), l = n.year, o = n.month, u = n.day, c = n.hours, d = n.minutes, h = n.seconds, p = n.milliseconds, $ = n.zone, g = n.week, M = /* @__PURE__ */ new Date(), D = u || (!l && !o ? M.getDate() : 1), S = l || M.getFullYear(), v = 0;
...
const kt = function(s, e, t) {
  ...
  i.parse = function(a) {
    ...
    if (typeof u == "string") {
      ...
      d && (p = o[2]), Y = this.$locale(), !c && p && (Y = t.Ls[p]), this.$d = It(n, u, l, t), this.init(), p && p !== !0 && (this.$L = this.locale(p).$L), h && n != this.format(u) && (this.$d = /* @__PURE__ */ new Date("")), Y = {};
...
class we extends Ye {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.userChangedValue = !1, this._value = null, this.disabled = !1, this.focusTrapDisabled = !1, this.hourFormat = "user", this.messages = tt(), this.open = !1, this.overlayPositioning = "absolute", this.placement = "auto", this.readOnly = !1, this.required = !1, this.scale = "m", this.status = "idle", this.step = 60, this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
  ...
  loaded() {
    je(this), K(this.value) && this.setLocalizedInputValue();
  }
  ...
  delocalizeTimeStringToParts(e, t) {
    ...
    let r = e;
    const a = Ze(this.effectiveHourFormat, i) ? Re(i) : Q(i);
    if (G.has(i) && a === "12") {
  ...
  async loadLocaleData() {
    ...
    const { default: t } = await Ct.get(e)();
