import { h as O, L as D, u as F, k as v, n as z, x as c, s as o, E as i, C as P, j as L } from "./iframe.js";
...
import { c as X, s as tt, a as et } from "./loadable.js";
import { i as b, B as it, n as u, p as rt, s as nt, h as at } from "./locale.js";
import { g as x } from "./component.js";
import { V as ot } from "./Validation.js";
import { u as st } from "./useT9n.js";
import { s as lt } from "./input.js";
/*!
...
class dt extends D {
  ...
  constructor() {
    ...
    }, this.previousValueOrigin = "initial", this.userChangedValue = !1, this._value = "", this.slottedActionElDisabledInternally = !1, this.alignment = "start", this.clearable = !1, this.disabled = !1, this.editingEnabled = !1, this.groupSeparator = !1, this.iconFlipRtl = !1, this.loading = !1, this.localeFormat = !1, this.messages = st(), this.multiple = !1, this.numberButtonType = "vertical", this.readOnly = !1, this.required = !1, this.scale = "m", this.status = "idle", this.type = "text", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
  ...
  incrementOrDecrementNumberValue(t, e, r, d) {
    ...
    if (n === "Infinity" || n === "-Infinity")
      return;
    const s = t === "up" ? 1 : -1, p = this.step === "any" ? 1 : Math.abs(this.step || 1), l = new it(n !== "" ? n : "0").add(`${p * s}`), h = () => typeof r == "number" && !isNaN(r) && l.subtract(`${r}`).isNegative, f = () => typeof e == "number" && !isNaN(e) && !l.subtract(`${e}`).isNegative, g = h() ? `${r}` : f() ? `${e}` : l.toString();
    this.setValue({
      committing: !0,
      nativeEvent: d,
      origin: "user",
  ...
  setValue({ committing: t = !1, nativeEvent: e, origin: r, previousValue: d, value: n }) {
    if (this.setPreviousValue(d ?? this.value), this.previousValueOrigin = r, this.type === "number") {
      ...
      const s = this.previousValue?.length > n.length || this.value?.length > n.length, p = n.charAt(n.length - 1) === ".", m = p && s ? n : nt(n), l = n && !m ? b(this.previousValue) ? this.previousValue : "" : m;
      let h = u.localize(l);
  ...
  render() {
    ...
    })} ${y(this.inputWrapperEl)}>${this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? p : null}${this.prefixText ? l : null}<div class=${o(a.wrapper)}>${B}${C}${this.isClearable ? r : null}${this.requestedIcon ? d : null}${this.loading ? e : null}</div><div class=${o(a.actionWrapper)} ${y(this.actionWrapperEl)}><slot name=${ct.action}></slot></div>${this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly ? m : null}${this.suffixText ? h : null}${this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? s : null}${R({ component: this })}</div>${this.validationMessage && this.status === "invalid" ? ot({ icon: this.validationIcon, id: k.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status }) : null}` });
  }
}
L("calcite-input", dt);
export {
