import { h as k, L as C, x as h, s as b, o as u, j as T } from "./iframe.js";
import { i as L } from "./keyed.js";
import { e as p, n as m } from "./ref.js";
import { s as M, a as V } from "./loadable.js";
import { c as S, a as F, d as R } from "./form.js";
import { g as O, n as P } from "./locale.js";
import { D as H } from "./dom.js";
...
class B extends C {
  ...
  // #region Lifecycle
  connectedCallback() {
    super.connectedCallback(), S(this), this.resizeObserver?.observe(this.el);
  }
  load() {
    M(this), this.calculateValues(), F(this, this.value);
  }
  willUpdate(e) {
  ...
  loaded() {
    V(this), this.updateLabels();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), R(this), this.resizeObserver?.disconnect();
  }
  // #endregion
  ...
  formatLabel(e, l) {
    if (l === "percent") {
      if (!this.percentFormatting) {
        const t = O(this.messages._lang), a = new Intl.NumberFormat(t, {
  ...
  intersects(e, l) {
    return e && l && H(e.getBoundingClientRect(), l.getBoundingClientRect());
  }
  ...
  render() {
    const { appearance: e, currentPercent: l, highActive: t, highPercent: a, label: i, lowActive: n, lowPercent: r, max: c, maxPercent: d, min: g, minPercent: o, rangeLabels: v, rangeLabelType: f, unitLabel: y, value: x, valueLabel: $, valueLabelType: w } = this, E = this.formatLabel(l / 100, "percent"), z = `${x} ${y}`;
    return h`<div .ariaLabel=${i} .ariaValueMax=${f === "percent" ? d : c} .ariaValueMin=${f === "percent" ? o : g} .ariaValueNow=${w === "percent" ? l : x} .ariaValueText=${w === "percent" ? E : y ? z : void 0} class=${b({
      [s.container]: !0,
      [s.stepsVisible]: v,
      [s.valueVisible]: $,
      [e]: e !== "outline-fill"
    })} role=meter ${m(this.meterContainerEl)}>${this.renderMeterFill()}${$ && this.renderValueLabel() || ""}${n && this.renderRangeLine(r) || ""}${t && this.renderRangeLine(a) || ""}${v && this.renderMinLabel() || ""}${v && n && this.renderLowLabel() || ""}${v && t && this.renderHighLabel() || ""}${v && this.renderMaxLabel() || ""}</div>`;
  }
}
T("calcite-meter", B);
export {
