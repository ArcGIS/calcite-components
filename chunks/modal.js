import { h as y, L as w, k as l, q as h, x as a, s as i, E as z, j as C } from "./iframe.js";
import { i as m } from "./keyed.js";
import { e as p, n as c } from "./ref.js";
import { g as b } from "./floating-ui.utils.dom.js";
import { f as $, d as u, s, E as g } from "./dom.js";
import { u as O, c as S, d, a as f } from "./focusTrapComponent.js";
import { c as T, s as E, a as B } from "./loadable.js";
import { c as v } from "./observers.js";
import { o as D } from "./openCloseComponent.js";
...
class I extends w {
  ...
  connectedCallback() {
    super.connectedCallback(), this.mutationObserver?.observe(this.el, { childList: !0, subtree: !0 }), this.cssVarObserver?.observe(this.el, { attributeFilter: ["style"] }), this.updateSizeCssVars(), S(this, {
      focusTrapOptions: {
  ...
  onOpen() {
    this.transitionEl?.classList.remove(t.openingIdle, t.openingActive), this.calciteModalOpen.emit(), f(this);
  }
  onBeforeClose() {
  ...
  handleOpenedChange(e) {
    const o = e ? t.openingIdle : t.closingIdle;
    this.transitionEl.classList.add(o), D(this);
  }
  handleCloseClick() {
    this.open = !1;
  }
  async openModal() {
    await this.componentOnReady(), this.el.addEventListener("calciteModalOpen", this.openEnd), this.opened = !0, this.titleId = g(this.titleEl), this.contentId = g(this.contentEl), b(this.el) === document.body && (r === 0 && (x = document.documentElement.style.overflow), r++, document.documentElement.style.setProperty("overflow", "hidden"));
  }
  handleOutsideClose() {
  ...
  removeOverflowHiddenClass() {
    document.documentElement.style.setProperty("overflow", x);
  }
  updateSizeCssVars() {
  ...
  // #region Rendering
  render() {
    return h(this.el, "aria-describedby", this.contentId), h(this.el, "aria-labelledby", this.titleId), this.el.ariaModal = "true", this.el.role = "dialog", a`<div class=${i({
      [t.container]: !0,
  ...
  renderCloseButton() {
    return this.closeButtonDisabled ? null : m("button", a`<button .ariaLabel=${this.messages.close} class=${i(t.close)} @click=${this.handleCloseClick} title=${this.messages.close ?? z} ${c(this.closeButtonEl)}><calcite-icon .icon=${L.close} .scale=${F(this.scale)}></calcite-icon></button>`);
  }
  renderStyle() {
