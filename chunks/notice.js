import { h, L as m, k as i, n as g, x as c, s as e, j as p } from "./iframe.js";
import { e as f, n as s } from "./ref.js";
import { u as a, s as u } from "./dom.js";
import { c as b, s as v, a as k } from "./loadable.js";
import { K as l } from "./resources3.js";
import { o as r } from "./openCloseComponent.js";
...
class z extends m {
  ...
  // #region Lifecycle
  async load() {
    v(this), this.requestedIcon = a(l, this.icon, this.kind), this.open && r(this);
  }
  willUpdate(t) {
    t.has("open") && (this.hasUpdated || this.open !== !1) && r(this), (t.has("icon") || t.has("kind") && (this.hasUpdated || this.kind !== "brand")) && (this.requestedIcon = a(l, this.icon, this.kind));
  }
  loaded() {
    k(this);
  }
  ...
  handleActionsEndSlotChange(t) {
    this.hasActionEnd = u(t);
  }
  // #endregion
  // #region Rendering
  render() {
    const t = c`<button .ariaLabel=${this.messages.close} class=${e(o.close)} @click=${this.close} ${s(this.closeButton)}><calcite-icon icon=x .scale=${d(this.scale)}></calcite-icon></button>`;
    return c`<div class=${e(o.container)} ${s(this.setTransitionEl)}>${this.requestedIcon ? c`<div class=${e(o.icon)}><calcite-icon .flipRtl=${this.iconFlipRtl} .icon=${this.requestedIcon} .scale=${d(this.scale)}></calcite-icon></div>` : null}<div class=${e(o.content)}><slot name=${n.title}></slot><slot name=${n.message}></slot><slot name=${n.link}></slot></div><div class=${e(o.actionsEnd)} .hidden=${!this.hasActionEnd}><slot name=${n.actionsEnd} @slotchange=${this.handleActionsEndSlotChange}></slot></div>${this.closable ? t : null}</div>`;
  }
}
p("calcite-notice", z);
export {
