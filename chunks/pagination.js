import { h as P, L as E, k as w, x as m, s as r, E as z, j as L } from "./iframe.js";
import { i as p } from "./keyed.js";
import { c as X, s as U, a as M } from "./loadable.js";
...
class B extends E {
  constructor() {
    super(...arguments), this.resizeHandler = ({ contentRect: { width: t } }) => this.setMaxItemsToBreakpoint(t), this.resizeObserver = F("resize", (t) => t.forEach(this.resizeHandler)), this.maxItems = h.xxsmall, this.groupSeparator = !1, this.messages = O(), this.pageSize = 20, this.scale = "m", this.startItem = 1, this.totalItems = 0, this.calcitePaginationChange = w({ cancelable: !1 });
  }
  static {
  ...
  async load() {
    U(this), this.handleTotalPages(), this.handleLastStartItemChange(), this.handleIsXXSmall();
  }
  willUpdate(t) {
  ...
  loaded() {
    M(this), this.setMaxItemsToBreakpoint(this.el.clientWidth);
  }
