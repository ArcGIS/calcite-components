import { h as u, L as f, k as s, x as p, s as b, E as m, j as k } from "./iframe.js";
...
import { u as C, I } from "./interactive.js";
import { c as R, d as z, g as L } from "./label.js";
import { c as A, s as F, a as E } from "./loadable.js";
/*!
...
class H extends f {
  ...
  async setFocus() {
    await A(this), this.disabled || x(this.containerEl);
  }
  connectedCallback() {
    this.rootNode = this.el.getRootNode(), this.name && this.checkLastRadioButton(), R(this), y(this), this.updateTabIndexOfOtherRadioButtonsInGroup(), super.connectedCallback();
  }
  load() {
    F(this);
  }
  ...
  loaded() {
    E(this), this.focused && !this.disabled && this.setFocus();
  }
  ...
  render() {
    ...
    return I({ disabled: this.disabled, children: p`<div .ariaChecked=${this.checked} .ariaLabel=${L(this)} class=${b(q.container)} @blur=${this.onContainerBlur} @focus=${this.onContainerFocus} role=radio tabindex=${e ?? m} ${v(this.setContainerEl)}><div class="radio"></div></div>${w({ component: this })}` });
  }
}
k("calcite-radio-button", H);
export {
  H as RadioButton
};
