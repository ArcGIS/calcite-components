import { h as D, L as I, k, q as B, x as y, s as p, C as T, j as $ } from "./iframe.js";
import { n as g } from "./ref.js";
import { i as H } from "./keyed.js";
import { i as C } from "./interact.min.js";
import { f as F, g as w, h as m, E as L } from "./dom.js";
import { u as M, c as R, d as S, a as E } from "./focusTrapComponent.js";
import { c as V, s as A, a as U } from "./loadable.js";
import { c as P } from "./observers.js";
import { o as j } from "./openCloseComponent.js";
import { g as O } from "./dynamicClasses.js";
import { c as K } from "./math.js";
...
class Y extends I {
  ...
  constructor() {
    super(), this.ignoreOpenChange = !1, this.messages = _(), this.mutationObserver = P("mutation", () => this.handleMutationObserver()), this._open = !1, this.openEnd = () => {
      ...
      maxInlineSize: 0,
      maxBlockSize: 0
    }, this.displayMode = "overlay", this.embedded = !1, this.escapeDisabled = !1, this.focusTrapDisabled = !1, this.heightScale = "m", this.opened = !1, this.outsideCloseDisabled = !1, this.position = "inline-start", this.resizable = !1, this.widthScale = "m", this.calciteSheetBeforeClose = k({ cancelable: !1 }), this.calciteSheetBeforeOpen = k({ cancelable: !1 }), this.calciteSheetClose = k({ cancelable: !1 }), this.calciteSheetOpen = k({ cancelable: !1 }), this.keyDownHandler = (e) => {
  ...
  static {
    this.properties = { resizeValues: 16, beforeClose: 0, displayMode: 3, embedded: 5, escapeDisabled: 7, focusTrapDisabled: 7, heightScale: 3, height: 3, label: 1, messageOverrides: 0, open: 7, opened: 7, outsideCloseDisabled: 7, position: 3, resizable: 7, widthScale: 3, width: 3 };
  }
  static {
    this.styles = W;
  }
  ...
  connectedCallback() {
    super.connectedCallback(), this.mutationObserver?.observe(this.el, { childList: !0, subtree: !0 }), R(this, {
      focusTrapOptions: {
  ...
  load() {
    A(this), this.open && this.openSheet();
  }
  willUpdate(e) {
    e.has("focusTrapDisabled") && (this.hasUpdated || this.focusTrapDisabled !== !1) && this.handleFocusTrapDisabled(this.focusTrapDisabled), e.has("opened") && (this.hasUpdated || this.opened !== !1) && j(this), (e.has("open") && (this.hasUpdated || this.open !== !1) || e.has("position") && (this.hasUpdated || this.position !== "inline-start") || e.has("resizable") && (this.hasUpdated || this.resizable !== !1)) && this.setupInteractions();
  }
  loaded() {
    U(this);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeOverflowHiddenClass(), this.mutationObserver?.disconnect(), S(this), this.embedded = !1, this.cleanupInteractions();
  }
  handleFocusTrapDisabled(e) {
    this.open && (e ? S(this) : E(this));
  }
  toggleSheet(e) {
  ...
  handleKeyDown(e) {
    ...
    if (!a || !h || s || !v.includes(t))
      return;
    const c = this.getContentElDOMRect(), b = w(r) === "rtl" ? -1 : 1, o = n ? N : q;
    switch (t) {
      case "ArrowUp":
        this.updateSize({
  ...
  updateSize({ type: e, size: t }) {
    ...
    if (!s)
      return;
    const i = e === "blockSize" ? "minBlockSize" : "minInlineSize", a = e === "blockSize" ? "maxBlockSize" : "maxInlineSize", h = n[i] && n[a] ? K(t, n[i], n[a]) : t, r = Math.round(h);
    this.resizeValues = {
      ...n,
      [e]: r
  ...
  setupInteractions() {
    ...
    this.resizeValues = d;
    const v = w(e) === "rtl";
    this.interaction = C(t, { context: e.ownerDocument }).resizable({
      edges: {
        top: n === "block-end" ? a : !1,
  ...
  onOpen() {
    this.calciteSheetOpen.emit(), E(this);
  }
  onBeforeClose() {
    this.calciteSheetBeforeClose.emit();
  }
  onClose() {
    this.calciteSheetClose.emit(), S(this);
  }
  setResizeHandleEl(e) {
    this.resizeHandleEl = e, this.setupInteractions();
  }
  setContentEl(e) {
    this.contentEl = e, this.contentId = L(e);
  }
  setTransitionEl(e) {
    this.transitionEl = e;
  }
  ...
  render() {
    ...
    return B(this.el, "aria-describedby", this.contentId), this.el.ariaLabel = this.label, this.el.ariaModal = "true", this.el.role = "dialog", y`<div class=${p({
      ...
      [T.rtl]: n === "rtl",
      [O("width", this.width, this.widthScale)]: !!(this.width || this.widthScale),
      [O("height", this.height, this.heightScale)]: !!(this.height || this.heightScale)
    })} ${g(this.setTransitionEl)}><calcite-scrim class=${p(l.scrim)} @click=${this.handleOutsideClose}></calcite-scrim><div class=${p(l.content)} ${g(this.setContentEl)}><div class=${p(l.contentContainer)}><slot></slot></div>${e ? H("resize-handle", y`<div .ariaLabel=${this.messages.resizeEnabled} .ariaOrientation=${i ? "vertical" : "horizontal"} .ariaValueMax=${i ? s.maxBlockSize : s.maxInlineSize} .ariaValueMin=${i ? s.minBlockSize : s.minInlineSize} .ariaValueNow=${i ? s.blockSize : s.inlineSize} class=${p(l.resizeHandle)} @keydown=${this.handleKeyDown} role=separator tabindex=0 touch-action=none ${g(this.setResizeHandleEl)}><div class=${p(l.resizeHandleBar)}><calcite-icon .icon=${this.getResizeIcon()} scale=s></calcite-icon></div></div>`) : null}</div></div>`;
  }
}
$("calcite-sheet", Y);
export {
