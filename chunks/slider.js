import { h as P, L as z, k as w, n as C, q as F, x as k, s as f, o as _, E as O, j as B } from "./iframe.js";
...
import { c as Y, s as Z, a as ee } from "./loadable.js";
import { n as H, B as te } from "./locale.js";
import { d as S, c as ae } from "./math.js";
...
class ne extends z {
  ...
  constructor() {
    ...
    }, H.localize(e.toString())), this.guid = `calcite-slider-${A()}`, this.messages = ie({ name: null }), this.pointerUpDragEnd = (e) => {
  ...
  load() {
    Z(this), g(this.value) || (this.value = this.snap ? this.getClosestStep(this.value) : this.clamp(this.value)), U(this, this.value);
  }
  willUpdate(e) {
   ...
   */
  clamp(e, t) {
    return e = ae(e, this.min, this.max), t === "maxValue" && (e = Math.max(e, this.minValue)), t === "minValue" && (e = Math.min(e, this.maxValue)), e;
  }
  /**
   ...
   */
  getClosestStep(e) {
    const { max: t, min: i, step: a } = this, s = new te(`${Math.floor((e - i) / a)}`).multiply(`${a}`).add(`${i}`).toString();
