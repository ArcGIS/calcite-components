import { h as l, L as n, k as o, q as c, x as r, s as t, E as d, j as p } from "./iframe.js";
import { e as h, n as m } from "./ref.js";
import { u, I as b } from "./interactive.js";
import { n as s } from "./locale.js";
import { c as g, s as v, a as f } from "./loadable.js";
...
class x extends n {
  ...
  static {
    this.properties = { complete: 7, description: 1, disabled: 7, error: 7, heading: 1, icon: 5, iconFlipRtl: 7, layout: 3, messageOverrides: 0, numbered: 5, numberingSystem: 1, scale: 3, selected: 7 };
  }
  static {
    this.styles = z;
  }
  ...
  async load() {
    v(this), this.parentStepperEl = this.el.parentElement, this.itemPosition = this.getItemPosition(), this.registerStepperItem(), this.selected && this.emitRequestedItem();
  }
  willUpdate(e) {
  ...
  handleItemClick(e) {
    this.disabled || this.layout === "horizontal" && e.composedPath().some((a) => a.classList?.contains("stepper-item-content")) || this.emitUserRequestedItem();
  }
  ...
  // #region Rendering
  render() {
    this.el.ariaCurrent = this.selected ? "step" : "false", c(this.el, "tabIndex", this.disabled ? -1 : 0);
    const e = this.layout === "horizontal" && !this.disabled ? 0 : null;
