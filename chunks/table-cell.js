import { h as i, L as c, x as o, s, C as a, E as n, j as r } from "./iframe.js";
import { e as d, n as h } from "./ref.js";
import { c as p, s as u, a as b } from "./loadable.js";
import { u as m, I as C } from "./interactive.js";
...
class v extends c {
  ...
  // #region Lifecycle
  async load() {
    u(this), this.updateScreenReaderContentsText(), this.updateScreenReaderSelectionText();
  }
  willUpdate(t) {
  ...
  // #region Rendering
  render() {
    const t = g(this.el), l = this.disabled || this.interactionMode === "static" && (!this.selectionCell || this.selectionCell && this.parentRowType === "foot");
    return C({ disabled: this.disabled, children: o`<td class=${s({
