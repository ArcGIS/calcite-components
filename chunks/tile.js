import { h as z, L as w, k as u, x as o, s as n, y as $, j as y } from "./iframe.js";
import { n as S } from "./ref.js";
import { u as E, I as T } from "./interactive.js";
import { s as A } from "./dom.js";
import { c as H, s as I, a as M } from "./loadable.js";
/*!
...
class D extends w {
  ...
  renderTile() {
    const { description: e, disabled: c, hasContentBottom: a, hasContentEnd: g, hasContentStart: f, hasContentTop: m, heading: l, icon: s, iconFlipRtl: x, interactive: i, selectionMode: h } = this, k = l && s && !e, p = !!this.href || !i, v = h === "multiple" && i ? "checkbox" : h !== "none" && i ? "radio" : i ? "button" : void 0, b = !!(e || g || f || l || s), C = !b && m && a;
    return o`<div .ariaChecked=${h !== "none" && i ? this.selected : void 0} .ariaDisabled=${p ? c : void 0} .ariaLabel=${v && this.label} class=${n({
      [t.container]: !0,
      [t.interactive]: i,
    ...
    })} @click=${this.clickHandler} .role=${v} tabindex=${(p ? void 0 : 0) ?? $} ${S(this.setContainerEl)}>${this.renderSelectionIcon()}<div class=${n({
      [t.contentContainer]: !0,
      [t.contentContainerHasContent]: b,
      [t.contentContainerHasOnlyContentTopAndBottom]: C
