import { h as U, L, k as I, x as m, s as o, j as T } from "./iframe.js";
...
import { c as E, s as _, a as B } from "./loadable.js";
import { d as h, g } from "./math.js";
import { g as j } from "./dom.js";
...
class J extends L {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.pointerActivated = !1, this.localizedDecimalSeparator = ".", this.hourFormat = "user", this.messages = W(), this.scale = "m", this.step = 60, this.value = null, this.calciteTimePickerChange = I({ cancelable: !1 }), this.listen("blur", this.blurHandler), this.listen("keydown", this.keyDownHandler), this.listen("pointerdown", this.pointerDownHandler);
  }
  static {
  ...
  setValue(e) {
    if (D(e)) {
      const { hour: i, minute: s, second: a, fractionalSecond: n } = v(e), { effectiveHourFormat: r, messages: { _lang: l }, numberingSystem: c } = this, { localizedHour: u, localizedHourSuffix: M, localizedMinute: F, localizedMinuteSuffix: P, localizedSecond: y, localizedDecimalSeparator: A, localizedFractionalSecond: V, localizedSecondSuffix: C, localizedMeridiem: $ } = H({
        value: e,
        locale: l,
        numberingSystem: c,
        hour12: r === "12"
      });
      this.hour = i, this.minute = s, this.second = a, this.fractionalSecond = this.sanitizeFractionalSecond(n), this.localizedHour = u, this.localizedHourSuffix = M, this.localizedMinute = F, this.localizedMinuteSuffix = P, this.localizedSecond = y, this.localizedDecimalSeparator = A, this.localizedFractionalSecond = V, this.localizedSecondSuffix = C, $ && (this.localizedMeridiem = $, this.meridiem = N(this.hour));
    } else
  ...
  setValuePart(e, i) {
    ...
    if (e === "meridiem") {
      ...
      this[e] = typeof i == "number" ? p(i) : i, this[`localized${G(e)}`] = S({
        value: this[e],
        part: e,
        locale: a,
        numberingSystem: n,
  ...
  render() {
    ...
    return m`<div class=${o({
      ...
      [t.column]: !0,
      [t.meridiemStart]: this.meridiemOrder === 0 || j(this.el) === "rtl"
