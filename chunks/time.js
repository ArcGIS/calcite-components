import { n as h, i as T, l as M, a as A, b as F } from "./locale.js";
...
function g(t) {
  ...
  if (!(e.length > 1 && e.length < 4))
    return !1;
  const [r, i, o] = e, u = parseInt(e[0]), c = parseInt(e[1]), f = parseInt(e[2]), d = T(r) && u >= 0 && u < 24, a = T(i) && c >= 0 && c < 60, m = T(o) && f >= 0 && f < 60;
  if (d && a && !o || d && a && m)
    return !0;
}
function w(t, e) {
...
function y({
  ...
  if (e === "fractionalSecond") {
    ...
    if (t) {
      ...
      parseInt(t) === 0 ? a = "".padStart(t.length, m) : (a = h.localize(`0.${t}`).replace(`${m}${d}`, ""), a.length < t.length && (a = a.padEnd(t.length, m)));
    }
    return a;
  }
  if (!w(t, e))
