import { h as I, L as E, k as $, x as a, s as n, q as M, E as A, j as z, C as d } from "./iframe.js";
...
class U extends E {
  ...
  handleChildrenSlotChange(e) {
    ...
    this.childTree = t, this.updateChildTree();
  }
  isActionEndEvent(e) {
  ...
  preWillUpdate() {
    this.hasChildren = !!this.el.querySelector("calcite-tree"), this.depth = 0;
  ...
  render() {
    const e = H(this.el) === "rtl", t = this.selectionMode === "single" || this.selectionMode === "children" || this.selectionMode === "single-persist", o = this.selectionMode === "multiple" || this.selectionMode === "multichildren", s = this.selectionMode === "none" && !this.hasChildren, m = this.hasChildren && this.indeterminate, l = this.hasChildren || this.selectionMode === "ancestors" ? a`<calcite-icon class=${n({
      [i.chevron]: !0,
      [d.rtl]: e
    })} data-test-id=icon .icon=${this.hasChildren ? c.chevronRight : c.blank} @click=${this.iconClickHandler} .scale=${h(this.scale)}></calcite-icon>` : null, f = g("default-slot", a`<slot></slot>`), p = this.selectionMode === "ancestors" ? a`<div class=${n(i.checkboxContainer)}><calcite-icon class=${n(i.checkbox)} .icon=${this.selected ? c.checkSquareF : m ? c.minusSquareF : c.square} .scale=${h(this.scale)}></calcite-icon></div>` : null, r = t ? c.bulletPoint : o ? c.checkmark : s ? c.blank : null, x = r ? a`<calcite-icon class=${n({
